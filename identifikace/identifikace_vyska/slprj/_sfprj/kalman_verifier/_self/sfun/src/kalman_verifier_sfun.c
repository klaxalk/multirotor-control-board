  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2337764330U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1879641825U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(115546451U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(823875106U);
  }
  ...
  debugInstance)
{
  _kalman_verifierMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "kalman_verifier","sfun",0,3,0,0,0);
