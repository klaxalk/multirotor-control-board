...
#include "c8_kalman_w_integrator.h"
...
static void initialize_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static void initialize_params_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static void enable_c8_kalman_w_integrator(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance);
static void disable_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static void set_sim_state_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static void sf_c8_kalman_w_integrator(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance);
static void initSimStructsc8_kalman_w_integrator
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_sum, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_c_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_memory, const char_T *c8_identifier, real_T
  c8_y[20]);
static void c8_d_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[20]);
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_kalman_w_integrator, const
  char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_kalman_w_integratorInstanceStruct
  *chartInstance);
  ...
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_kalman_w_integrator = 0U;
}
  ...
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance)
{
  ...
  c8_c_hoistedGlobal = chartInstance->c8_is_active_c8_kalman_w_integrator;
  ...
  (SFc8_kalman_w_integratorInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_sum = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
    "sum");
  chartInstance->c8_is_active_c8_kalman_w_integrator = c8_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
     "is_active_c8_kalman_w_integrator");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_kalman_w_integrator(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_kalman_w_integratorInstanceStruct *chartInstance;
  chartInstance = (SFc8_kalman_w_integratorInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_kalman_w_integrator_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_kalman_w_integrator), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_kalman_w_integrator);
  return c8_y;
}
...
void sf_c8_kalman_w_integrator_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_kalman_w_integrator_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_kalman_w_integrator_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_kalman_w_integrator_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_kalman_w_integrator(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[7],T\"confidence\",},{M[1],M[13],T\"memory\",},{M[1],M[14],T\"sum\",},{M[8],M[0],T\"is_active_c8_kalman_w_integrator\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_kalman_w_integrator_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_kalman_w_integratorInstanceStruct *chartInstance;
    chartInstance = (SFc8_kalman_w_integratorInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c8_kalman_w_integrator(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_kalman_w_integratorInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_kalman_w_integrator
    ((SFc8_kalman_w_integratorInstanceStruct*) chartInstanceVar);
  initialize_c8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_kalman_w_integrator(void *chartInstanceVar)
{
  enable_c8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_kalman_w_integrator(void *chartInstanceVar)
{
  disable_c8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_kalman_w_integrator(void *chartInstanceVar)
{
  sf_c8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_kalman_w_integrator(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_kalman_w_integrator
    ((SFc8_kalman_w_integratorInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_kalman_w_integrator();/* state var info */
...
extern void sf_internal_set_sim_state_c8_kalman_w_integrator(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_kalman_w_integrator(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c8_kalman_w_integrator(S);
}

static void sf_opaque_set_sim_state_c8_kalman_w_integrator(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_kalman_w_integrator(S, st);
}

static void sf_opaque_terminate_c8_kalman_w_integrator(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_kalman_w_integratorInstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_kalman_w_integrator((SFc8_kalman_w_integratorInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_kalman_w_integrator(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_kalman_w_integrator
      ((SFc8_kalman_w_integratorInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_kalman_w_integrator(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_kalman_w_integrator(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_kalman_w_integrator(SimStruct *S)
{
  SFc8_kalman_w_integratorInstanceStruct *chartInstance;
  chartInstance = (SFc8_kalman_w_integratorInstanceStruct *)utMalloc(sizeof
    (SFc8_kalman_w_integratorInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_kalman_w_integratorInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_kalman_w_integrator;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_kalman_w_integrator;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_kalman_w_integrator;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_kalman_w_integrator;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_kalman_w_integrator;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_kalman_w_integrator;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_kalman_w_integrator;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_kalman_w_integrator;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_kalman_w_integrator;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_kalman_w_integrator;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_kalman_w_integrator;
...
void c8_kalman_w_integrator_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_kalman_w_integrator(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_kalman_w_integrator(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_kalman_w_integrator(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_kalman_w_integrator_method_dispatcher.\n"
