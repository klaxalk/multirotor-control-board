...
quadrohor::quadrohor(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::quadrohor)
{
    ui->setupUi(this);
...
void quadrohor::graph_1(QCustomPlot *graph1)
{
...
void quadrohor::realtimeDataSlotGraph1()
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    double key1 = 0;
#else
    ...
    /*  if (key-lastFpskey > 2) // average fps over 2 seconds
  {
    ...
    // delay
    //   if(ui->quadrohor1Signal1->isChecked()||ui->quadrohor1Signal2->isChecked()||ui->quadrohor1Signal3->isChecked()||ui->quadrohor1Signal4->isChecked()
    //       ||ui->quadrohor1Signal5->isChecked()||ui->quadrohor1Signal6->isChecked()||ui->quadrohor1Signal7->isChecked()||ui->quadrohor1Signal8->isChecked()){
    //   }

}

void quadrohor::graph_2(QCustomPlot *graph2)
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    QMessageBox::critical(this, "", "You're using Qt < 4.7, the realtime data needs functions that are available with Qt 4.7 to work properly");
#endif
...
void quadrohor::realtimeDataSlotGraph2()
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    double key2 = 0;
#else
...
void quadrohor::createScrollCheckBox()
{
...
void quadrohor::setAllCheckFalse()
{
    for(int i=0;i<33;i++){
...
void quadrohor::on_comboBox_activated(int index)
{
    if(index==0){
        setAllCheckFalse();
        for(int i=0;i<33;i++){
...
void quadrohor::Plot1SignalAll_clicked()
{
...
void quadrohor::Plot1Signals_clicked(){
    for(int i=0;i<32;i++){
        if(!Plot1Signals[i]->isChecked()){
...
void quadrohor::Plot2SignalAll_clicked()
...
void quadrohor::Plot2Signals_clicked(){
    for(int i=0;i<32;i++){
        if(!Plot2Signals[i]->isChecked()){
...
void quadrohor::on_actionK1_triggered()
{
    kopter=KOPTERS.K1;
    setSignalsOn();
...
void quadrohor::on_actionK2_triggered()
{
    kopter=KOPTERS.K2;
    setSignalsOn();
    startFailureDetectionThread();
...
void quadrohor::on_actionK3_triggered()
{
    kopter=KOPTERS.K3;
    setSignalsOn();
    startFailureDetectionThread();
...
void quadrohor::on_actionKC1_triggered()
{
    kopter=KOPTERS.KC1;
    setSignalsOn();
    startFailureDetectionThread();
...
// Landing
void quadrohor::on_actionOn_triggered()
{
    land(kopter,ONOFF.ON);
}

void quadrohor::on_actionOff_triggered()
{
    land(kopter,ONOFF.OFF);
}
// controllers
void quadrohor::on_actionVelocity_triggered()
{
    setController(kopter,CONTROLLERS.VELOCITY);
}

void quadrohor::on_actionPosition_triggered()
{
    setController(kopter,CONTROLLERS.POSITION);
}
void quadrohor::on_actionBoth_triggered()
{
    setController(kopter,CONTROLLERS.MPC);
}

void quadrohor::on_actionOff_3_triggered()
{
    setController(kopter,CONTROLLERS.OFF);
}

// setpoints
void quadrohor::on_actionRelative_triggered()
{    bool ok;
...
void quadrohor::on_actionAbsolute_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionRelative_2_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionAbsolute_2_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionRelative_3_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionAbsolute_3_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionRelative_4_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionAbsolute_4_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionRelative_5_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrohor::on_actionAbsolute_5_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
// Trajectory
void quadrohor::on_actionFollow_trajectory_triggered()
{
    trajectoryFollow(kopter,ONOFF.ON);
}
void quadrohor::on_actionFollow_trajectory_off_triggered()
{
    trajectoryFollow(kopter,ONOFF.OFF);
}

void quadrohor::on_actionLoad_trajectory_triggered()
{
...
void quadrohor::closeEvent (QCloseEvent *event)
{
...
void quadrohor::startFailureDetectionThread()
{
...
void quadrohor::on_pushButton_clicked()
{
...
void quadrohor::CheckSignalsForTurning()
{
