...
quadrover::quadrover(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::quadrover)
{
    ui->setupUi(this);
...
void quadrover::graph_1(QCustomPlot *graph1)
{
...
void quadrover::realtimeDataSlotGraph1()
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    double key1 = 0;
#else
    ...
    /*  if (key-lastFpskey > 2) // average fps over 2 seconds
  {
    ...
    // delay
    //   if(ui->quadrover1Signal1->isChecked()||ui->quadrover1Signal2->isChecked()||ui->quadrover1Signal3->isChecked()||ui->quadrover1Signal4->isChecked()
    //       ||ui->quadrover1Signal5->isChecked()||ui->quadrover1Signal6->isChecked()||ui->quadrover1Signal7->isChecked()||ui->quadrover1Signal8->isChecked()){
    //   }

}

void quadrover::graph_2(QCustomPlot *graph2)
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    QMessageBox::critical(this, "", "You're using Qt < 4.7, the realtime data needs functions that are available with Qt 4.7 to work properly");
#endif
...
void quadrover::realtimeDataSlotGraph2()
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
    double key2 = 0;
#else
...
void quadrover::createScrollCheckBox()
{
...
void quadrover::on_comboBox_activated(int index)
{
    if(index==0){
        setAllCheckFalse();
        for(int i=0;i<38;i++){
...
void quadrover::realtimeDataStatus()
{
...
void quadrover::on_actionK1_triggered()
{
    kopter=KOPTERS.K1;
    setSignalsOn();
...
void quadrover::on_actionK2_triggered()
{
    kopter=KOPTERS.K2;
    setSignalsOn();
    startFailureDetectionThread();
...
void quadrover::on_actionK3_triggered()
{
    kopter=KOPTERS.K3;
    setSignalsOn();
    startFailureDetectionThread();
...
void quadrover::on_actionKC1_triggered()
{
    kopter=KOPTERS.KC1;
    setSignalsOn();
    startFailureDetectionThread();
...
// Landing
void quadrover::on_actionOn_triggered()
{
    land(kopter,ONOFF.ON);
}

void quadrover::on_actionOff_triggered()
{
    land(kopter,ONOFF.OFF);
}
// controllers
void quadrover::on_actionVelocity_triggered()
{
    setController(kopter,CONTROLLERS.VELOCITY);
}

void quadrover::on_actionPosition_triggered()
{
...
// setpoints
void quadrover::on_actionRelative_triggered()
{    bool ok;
...
void quadrover::on_actionAbsolute_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionRelative_2_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionAbsolute_2_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionRelative_3_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionAbsolute_3_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionRelative_4_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionAbsolute_4_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionRelative_5_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
void quadrover::on_actionAbsolute_5_triggered()
{    bool ok;
     double d = QInputDialog::getDouble(this, tr("Enter value"),
                                        tr("Amount:"), 0, -100, 100, 2, &ok);
...
// Trajectory
void quadrover::on_actionFollow_trajectory_triggered()
{
    trajectoryFollow(kopter,ONOFF.ON);
}
void quadrover::on_actionFollow_trajectory_off_triggered()
{
    trajectoryFollow(kopter,ONOFF.OFF);
}

void quadrover::on_actionLoad_trajectory_triggered()
{
...
void quadrover::closeEvent (QCloseEvent *event)
{
...
void quadrover::on_pushButton_clicked()
{
