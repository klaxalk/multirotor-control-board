...
#define PRASE	1
	...
	#define THROTTLE_A43 -0.74291
	#define THROTTLE_A44 1.67972

	#define THROTTLE_B3 0.10454
	#define THROTTLE_B4 0.11146

    #define THROTTLE_Q 100
	#define THROTTLE_INIT_OMEGA -15.2
	#define THROTTLE_INIT_ERROR 5.5
