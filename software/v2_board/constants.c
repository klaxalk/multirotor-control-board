...
void constInit(){
	...
	TELEMETRIES.ELEVATOR_SPEED_SETPOINT=0x0F;
	TELEMETRIES.AILERON_SPEED_SETPOINT=0x10;
	TELEMETRIES.ELEVATOR_ACC=0x11;
	TELEMETRIES.AILERON_ACC=0x12;
	TELEMETRIES.VALID_GUMSTIX=0x13;
	TELEMETRIES.OUTPUT_THROTTLE=0x14;
	TELEMETRIES.OUTPUT_ELEVATOR=0x15;
	TELEMETRIES.OUTPUT_AILERON=0x16;
	TELEMETRIES.OUTPUT_RUDDER=0x17;
	TELEMETRIES.BLOB_ELEVATOR=0x18;
	TELEMETRIES.BLOB_AILERON=0x19;
	TELEMETRIES.BLOB_ALTITUDE=0x1A;
	TELEMETRIES.PITCH_ANGLE=0x1B;
	TELEMETRIES.ROLL_ANGLE=0x1C;
	...
	COMMANDS.LOCK_ON_BLOB=0x05;
	COMMANDS.FOLLOWER_SET=0x06;
	COMMANDS.TIME=0x07;
	COMMANDS.POSITION_SET=0x08;
